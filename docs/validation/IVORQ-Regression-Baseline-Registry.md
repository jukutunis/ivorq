...
|----|--------|-------------|
| `frontdesk-operational-baseline` | `active` | Front Desk operational tests through Package 8 checkout confirmation and execute authorization foundation — 63 classes, 674 tests / 6490 assertions |
