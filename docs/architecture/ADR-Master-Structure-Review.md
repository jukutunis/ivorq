...
### Package 9 Governance Activation (2026-07-27)

Contract Version 1.15. Canonical predecessor: `2395884479a69dfa3a876728137676e61a7b374e`. Package 8 is accepted and merged through PR #40 at `2395884479a69dfa3a876728137676e61a7b374e`; accepted Package 8 feature head: `eb20396ff3f42fc6f9273d3757ee80ab996b2b4d`; Package 8 final source provenance: `94a87dad7422f5a7f16656d34432428f0f4a7100`.

Package 8 accepted validation evidence:

- Front Desk baseline: 686 tests / 6679 assertions / 0 failures / 0 errors.
- Package 8 focused: 33 tests / 333 assertions / 0 failures / 0 errors.
...
No new ADR is required because ADR-087 already freezes the Front Desk checkout command boundary, and ADR-089 already defines the single PostgreSQL transaction, owner-domain participating attestation ports, ownership matrix, global lock order, durable confirmation claim semantics, idempotency/replay, failure recovery, immutable execution evidence, terminal stay transition, and transactional Housekeeping handoff. Package 8 supplied the remaining checkout confirmation and execute-authorization foundation. Package 9 is implementation of already approved architecture, not a new long-lived architectural decision.

Package 9 - Final Front Desk Checkout Command, Atomic Terminal Transaction Orchestration, Controlled Write Route, and Hospitality Interaction Layer - is the current governance-authorized boundary. Package 9 runtime remains unimplemented and requires a separate runtime package and Draft PR. PMS readiness remains partial until Package 9 runtime is implemented, reviewed, accepted, and merged. This governance package does not claim full production checkout readiness.
...
The future Package 9 browser request remains identifier-only:
...
The browser must not control trusted Company, Property, Tenant, actor, role, permission, membership, guest, reservation, room, stay status, business date, Night Audit, folio, amount, currency, payment, settlement, cashier, attestation, source fingerprint, confirmation, audit timestamp, execution, Housekeeping readiness, handoff, or retry outcome values. Front Desk must preserve owner-domain boundaries and must not directly mutate PMS Guest Ledger, PMS Cashiering, General Cashier, Business Date, Night Audit, Housekeeping readiness, room readiness, Engineering availability, Accounting, GL, AR, tax, revenue, or financial-period lifecycle rows.
