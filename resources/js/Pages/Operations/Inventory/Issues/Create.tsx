...
export default function IssueCreate({ items, locations }: Props) {
    ...
    function submit(e: React.FormEvent) { e.preventDefault(); post('/operations/inventory/issues'); }
        ...
        <AppLayout>
            ...
            <form onSubmit={submit} className="max-w-4xl space-y-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/operations/inventory/issues" className="bg-gray-100 text-gray-700 px-5 py-2 rounded text-sm hover:bg-gray-200">Cancel</Link>
                </div>
            </form>
        </AppLayout>
    );
