...
export default function ItemCreate({ categories, units }: Props) {
        ...
        <AppLayout>
            ...
            <form onSubmit={submit} className="max-w-3xl">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" value={data.item_code}
                                ...
                                placeholder="e.g. HK-001" maxLength={30}
                        ...
                        <div>
                            ...
                            <input type="text" value={data.name}
                                ...
                                placeholder="Item name" maxLength={150}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" value={data.sku}
                                ...
                                placeholder="Optional SKU" maxLength={100}
                                className="border border-gray-300 rounded px-3 py-2 text-sm w-full focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono" />
                        ...
                        <div>
                            ...
                            <input type="text" value={data.barcode}
                                ...
                                placeholder="Optional barcode" maxLength={100}
                                className="border border-gray-300 rounded px-3 py-2 text-sm w-full focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono" />
                ...
                <div className="flex items-center gap-3 mt-4">
                    ...
                    <Link href="/operations/inventory/items" className="bg-gray-100 text-gray-700 px-5 py-2 rounded text-sm hover:bg-gray-200">Cancel</Link>
                </div>
            </form>
        </AppLayout>
    );
