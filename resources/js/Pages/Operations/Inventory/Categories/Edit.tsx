    ...
    return (
        <AppLayout>
            <div className="flex items-center gap-3 mb-6">
                <Link href={`/operations/inventory/categories/${category.id}`} className="text-sm text-gray-500 hover:text-gray-700">
                    ← {category.name}
                </Link>
            </div>
            ...
            <form onSubmit={submit} className="max-w-2xl">
                ...
                <div className="flex items-center gap-3 mt-4">
                    ...
                    <Link href={`/operations/inventory/categories/${category.id}`} className="bg-gray-100 text-gray-700 px-5 py-2 rounded text-sm hover:bg-gray-200">
                        Cancel
                    </Link>
                </div>
            </form>
