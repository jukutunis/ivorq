...
interface Props { location_types: EnumOption[]; }

export default function LocationCreate({ location_types }: Props) {
        ...
        <AppLayout>
            ...
            <form onSubmit={submit} className="max-w-2xl">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" value={data.location_code}
                                ...
                                placeholder="e.g. MAIN-STR" maxLength={30}
                        ...
                        <div>
                            ...
                            <input type="text" value={data.name}
                                ...
                                placeholder="e.g. Main Storeroom" maxLength={100}
                ...
                <div className="flex items-center gap-3 mt-4">
                    ...
                    <Link href="/operations/inventory/locations" className="bg-gray-100 text-gray-700 px-5 py-2 rounded text-sm hover:bg-gray-200">Cancel</Link>
                </div>
            </form>
        </AppLayout>
    );
