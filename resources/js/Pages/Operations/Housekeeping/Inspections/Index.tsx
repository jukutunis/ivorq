...
import { RoomInspection, PaginatedData, EnumOption } from '@/Types';

interface Props {
    inspections:      PaginatedData<RoomInspection>;
...
export default function InspectionIndex({ inspections, inspection_types, statuses }: Props) {
    function applyFilter(field: string, value: string) {
        router.get(
            ...
            { [field]: value || undefined } as Record<string, string | undefined>,
            { preserveState: true }
        );
    }
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        {inspections.total} inspection{inspections.total !== 1 ? 's' : ''} total
                    </p>
                </div>
