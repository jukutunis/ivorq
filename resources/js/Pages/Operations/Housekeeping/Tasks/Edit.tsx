...
import { CleaningTask, EnumOption } from '@/Types';
...
export default function TaskEdit({ task, task_types }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        task_code:                  task.task_code,
        title:                      task.title,
        description:                task.description ?? '',
        task_type:                  String(task.task_type.value),
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        put(`/operations/cleaning-tasks/${task.id}`);
    }
            ...
            <form onSubmit={submit} className="max-w-2xl">
                <div className="bg-white rounded-lg shadow p-6 space-y-5">
                    ...
                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded border border-gray-200 text-sm text-gray-600">
                        ...
                        To change the task status, use the Start / Complete / Cancel actions on the task detail page.
                    </div>
                ...
                <div className="flex items-center gap-3 mt-4">
                    ...
                    <Link
                        ...
                        onBefore={() => confirm('Delete this task? This action cannot be undone.')}
                    >
                        Delete Task
                    </Link>
                </div>
