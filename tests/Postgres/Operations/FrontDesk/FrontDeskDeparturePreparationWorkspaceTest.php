...
class FrontDeskDeparturePreparationWorkspaceTest extends PostgresTestCase
{
    ...
    public function test_workspace_renders_departure_surface(): void
    {
        ...
        $response->assertInertia(fn (Assert $page) => $page
            ...
            ->where('departureWorkspace.views.dueOutToday.0.financial_marker', 'Financial settlement: Not evaluated in Front Desk Package B3.')
            ->where('departureWorkspace.financial_marker', 'Financial settlement: Not evaluated in Front Desk Package B3.')
        );
    }
