...
class GuestDepositRefundArTransferMigrationProofTest extends TestCase
{
    public function test_glf_c_up_down_reapply_and_legacy_blocker_use_disposable_databases():void
    {
        ...
        foreach(['proof_db_created','ambiguous_db_created','pre_glfc_ok','up_ok','up_tables','up_columns','up_constraints','up_triggers','up_source_indexes','up_source_index_defs','valid_rows','invalid_sql_blocked','duplicate_deposit_app_rejected','duplicate_ar_accept_rejected','down_ok','down_tables_removed','down_columns_removed','down_source_indexes_removed','glfa_glfb_preserved','reapply_ok','reapply_source_indexes','ambiguous_blocked','ambiguous_no_partial','ambiguous_row_preserved','proof_db_dropped','ambiguous_db_dropped']as$key)$this->assertTrue($r[$key]??false,"Migration proof failed: {$key}; ".json_encode($r));
