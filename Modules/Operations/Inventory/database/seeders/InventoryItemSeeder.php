...
class InventoryItemSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if ($cats->isEmpty()) {
            $this->command->warn('InventoryItemSeeder: categories not found — run InventoryCategorySeeder first.');
        ...
        $items = [
            ...
            [
                ...
                'weighted_average_cost' => '1200.0000',
            ...
            [
                ...
                'category_name' => 'HK-AMEN',
                'weighted_average_cost' => '3500.0000',
            ...
            [
                ...
                'category_name' => 'HK-AMEN',
                'weighted_average_cost' => '85000.0000',
            ...
            [
                ...
                'category_name' => 'HK-AMEN',
                'weighted_average_cost' => '120000.0000',
            ...
            [
                ...
                'category_name' => 'HK-AMEN',
                'weighted_average_cost' => '8500.0000',
            ...
            [
                ...
                'weighted_average_cost' => '25000.0000',
            ...
            [
                ...
                'category_name' => 'ENG-PARTS',
                'weighted_average_cost' => '45000.0000',
            ...
            [
                ...
                'category_name' => 'ENG-PARTS',
                'weighted_average_cost' => '5000.0000',
            ...
            [
                ...
                'category_name' => 'ENG-PARTS',
                'weighted_average_cost' => '22000.0000',
            ...
            [
                ...
                'weighted_average_cost' => '185000.0000',
                'reorder_point' => '5.000',
            ...
            [
                ...
                'category_name' => 'LAUNDRY',
                'weighted_average_cost' => '220000.0000',
                'reorder_point' => '3.000',
            ...
            [
                ...
                'category_name' => 'LAUNDRY',
                'weighted_average_cost' => '35000.0000',
                'reorder_point' => '8.000',
            ...
            [
                ...
                'weighted_average_cost' => '8000.0000',
            ...
            [
                ...
                'category_name' => 'MINIBAR',
                'weighted_average_cost' => '12000.0000',
            ...
            [
                ...
                'category_name' => 'MINIBAR',
                'weighted_average_cost' => '15000.0000',
                'reorder_point' => '60.000',
            ...
            [
                ...
                'weighted_average_cost' => '55000.0000',
                'reorder_point' => '20.000',
            ...
            [
                ...
                'category_name' => 'OFFICE',
                'weighted_average_cost' => '350000.0000',
                'reorder_point' => '2.000',
