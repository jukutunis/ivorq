...
/**
 * final invocation service to coordinate posting issue stock transactions
 * and applying controlled issue valuations in a single atomic database transaction.
 */
final class ControlledIssueValuationInvocationService
{
    ...
    /**
     * Atomically invoke controlled issue valuation.
     *
    ...
    public function invokeIssue(
        ...
        $ledgerIntent = new ControlledValuationCostLedgerIntent(
            ...
            entryType: 'issue', // Enforced issue type
